...
*/
    ...
    ReadFile(FILES) {for(let e in FILES){if(e=='version')continue;let t=e.split(".")[0];"libunrar.js.mem"==e&&(t="libunrarmem"),"v.json"==e&&(t="vjson"),this.config[t]=window.URL.createObjectURL(new Blob([FILES[e]])),delete FILES[e]}FILES=null,this.addjs(this.config.emulator,(()=>{window.URL.revokeObjectURL(this.config.emulator),delete this.config.emulator,this.ready=!0}));}
